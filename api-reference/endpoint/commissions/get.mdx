...
- **affiliate** (object): Affiliate object (see Affiliate schema). Only present when `expand=affiliate`.
- **affiliate_program** (object): Affiliate program object containing program details. Only present when `expand=affiliate_program`.
- **referral** (object): Referral object (see Referral schema). Only present when `expand=referral`.
