...
<Note>
  ...
  - **Public** (auto-approve): `partnershipStatus` is `APPROVED` – affiliate can start referring immediately
  - **Private** (manual approval): `partnershipStatus` is `PENDING` – requires manual approval in your dashboard
</Note>
