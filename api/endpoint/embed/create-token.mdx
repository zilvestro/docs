...
<ResponseField name="data" type="object">
  ...
  <Expandable title="Data Object Properties">
    ...
    <ResponseField name="partnershipStatus" type="string">
      ...
      This depends on your program's **Access Mode** setting (Open vs Private).
    </ResponseField>
  </Expandable>
</ResponseField>
...
4. **Partnership**: New affiliates are enrolled in the program with a status based on your program's **Access Mode** setting:
   - **Open** (auto-approve) → Partnership status is `APPROVED` (affiliate can start referring immediately)
